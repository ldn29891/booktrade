import{q as Et,m as vd,d as Tc,o as Ad,F as Rd,a as Pd,L as Xt,l as Ls,j as Vd,g as Sd,r as As,x as bd,A as Ec,S as Cd,f as xd,C as Dd,G as ou}from"./index.esm2017-fYHA5Hly.js";var au=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pe=new Pd("@firebase/firestore");function cn(){return pe.logLevel}function fp(r){pe.setLogLevel(r)}function C(r,...t){if(pe.logLevel<=Xt.DEBUG){const e=t.map(oo);pe.debug(`Firestore (${xn}): ${r}`,...e)}}function ft(r,...t){if(pe.logLevel<=Xt.ERROR){const e=t.map(oo);pe.error(`Firestore (${xn}): ${r}`,...e)}}function Ut(r,...t){if(pe.logLevel<=Xt.WARN){const e=t.map(oo);pe.warn(`Firestore (${xn}): ${r}`,...e)}}function oo(r){if(typeof r=="string")return r;try{/**
* @license
